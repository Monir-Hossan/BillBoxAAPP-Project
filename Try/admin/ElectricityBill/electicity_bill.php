...
<div id="header">
  ...
  <div id="menu">
    ...
    <div class="dropdown-content">
      ...
      <a href="jesonelectricity.php">JesonCodeView</a>
       <a href="electicity_bill.php">ElectricityBillPage</a>
        <a href="addnewuserfrom.php">AddnewuserElectricityBillPage</a>
...
<form id="electricity" name="cusinfo" method="post" action="insertelectricitytable.php";>
  ...
  <tr >
    <td>Bill Box </td><td></td><td></td><td> </td>
     </tr>
...
<tr>
<td>KWH Consumerd:</td><td>'.$consumption.' </td><td> MeterAccount:</td> <td>'.$accountno.'
</td>
    </tr>
