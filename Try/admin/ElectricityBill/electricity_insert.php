...
<tr>
    ...
    <td colspan="0">Name & address:</td><td> <select input id="nameadd" input name="nameadd"  type="text"  maxlength="19">';
  include("config.php");
...
<td>Billing Month: </td><td><select input id="billmonth" input name="billmonth"  type="text"  maxlength="19">
  ...
  <td>Bill No:</td><td><select input id="billno" input name="billno"  type="text"  maxlength="30">';
  include("config.php");
...
<tr>
<td>KWH Consumerd:</td><td> <input id="unit" input name="unit"
 value="'.$unit.'" type="text"  maxlength="30"></td>
...
<select input id="accountno" input name="accountno"    type="text"  maxlength="30">';
...
echo ' '.$macc.'</option>';}
 ...
 <tr>
      <td>Energy charge: </td><td><input id="total" input name="total" value="'.$total.'" type="text"  maxlength="30" placeholder="Energy charge..."></td>
      <td>Date</td><td><input id="date" input name="date"  type="date" ></td>
</tr>

<tr>
    <td>MeterCharge:</td><td><input id="meter" input name="meter" value="'.$meter.'" type="text"  maxlength="30"></td>
     <td></td><td></td>

<tr>
<td>Total:</td><td><input id="newTotal" input name="newTotal" value="'.$newTotal.'" type="text"  maxlength="30"></td>
<td></td><td></td>
</tr>
...
<tr>
 ...
 <td>Vat:</td><td><input id="vat" input name="vat" value="'.$vat.'"  type="text"  maxlength="30"></td>
 <td></td><td></td>
...
<tr>
 ...
 <td>G.Total :</td><td><input id="gTotal" input name="gTotal" value="'.$gTotal.'" type="text"  maxlength="30"> </td>
 <td></td><td></td>
</tr>
   ...
   <tr>
    <td>Transaction Id:</td><td><select input id="transaction" input name="transaction"  type="text"  maxlength="30">';
  include("config.php");
