...
$gas = "CREATE TABLE IF NOT EXISTS gas(	id TINYINT NOT NULL auto_increment,
							PRIMARY KEY (id),
...
$query = mysqli_query($myConnection, $gas);
if ($query === TRUE) {
	echo "<h3>gas_bill table created OK :) </h3>"; 
} else {
	echo "<h3>gas_bill table NOT created :( </h3>"; 
}
?>