...
<form id="gas" name="cusinfo" method="post" action="insertGasbilltable.php";>

  <tr >
    <td>Bill Box </td><td>Gas Bill </td>
     </tr>
<tr >
    <td colspan="3">Name & address:<br> <input id="nameadd" input name="nameadd"  type="text"  maxlength="30"> <br>

    </td>
    </tr>
    <tr>
<td>Billing Month:<br> <input id="billmonth" input name="billmonth"  type="text"  maxlength="19"> </td><td>Bill No:<br><input id="billno" input name="billno"  type="text"  maxlength="19"></td>
    </tr>

<td>KWH Consumerd:<br> <input id="consumption" input name="consumption"  type="text"  maxlength="19"></td><td>Account No:
  <br><br><br>
<input id="accountno" input name="accountno"  type="text"  maxlength="19"></td>
    </tr>

    </tr>
<td colspan="3">Normal: <br>
Energy charge: <br><input id="energycharge" input name="energycharge"  type="text"  maxlength="19">

<br>Others:<br><input id="other" input name="other"  type="text"  maxlength="19">
<br> Total Bill:<br><input id="totalbill" input name="totalbill"  type="text"  maxlength="19">

<br>Due Bill:<br><input id="duebill" input name="duebill"  type="text"  maxlength="19"> <br>

Total paid after due date:<br><input id="dateafterpay" input name="dateafterpay"  type="text"  maxlength="19"></td></tr>

    

   <tr><td colspan="3">Transaction Id:<br><input id="transaction" input name="transaction"  type="text"  maxlength="19"> </td></tr>
   </tr>
<td>Back</td><td>Payment</td>
<tr><td><button id="btn" input type="submit">Submit</button><br ></td></tr>
    </tr>
...
<div class="container">
    ...
    if(isset($_POST['unit']))
    {
      ...
      <tfoot>
     <form id="electricity" name="cusinfo" method="post" action="insertGasbilltable.php";>
  <tr >
